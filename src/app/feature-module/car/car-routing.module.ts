...
const routes: Routes = [
  { path: '', 
    ...
    children:[
      ...
      { path: 'add-service', loadChildren: () => import('./add-car/add-car.module').then(m => m.AddCarModule) },
      { path: 'car-booking', loadChildren: () => import('./car-booking/car-booking.module').then(m => m.CarBookingModule) },
      { path: 'manage-service', loadChildren: () => import('./edit-car/edit-car.module').then(m => m.EditCarModule) },
    ]
   },
