...
public static get agentListings(): string {
  return this.agent + '/properties';
}

public static get agentCustomization(): string {
  return this.agent + '/customize';
}

public static get agentCategory(): string {
  return this.agent + '/category';
}
public static get userMangment(): string {
  return this.agent + '/users';
}

public static get addCustoms(): string {
  return this.agent + '/customize/add';
}
public static get editCustoms(): string {
  return this.agent + '/customize/edit';
}
...
public static get editProperty(): string {
  return this.property + '/edit-property';
}
