...
export class DataService {
  ...
  public sideBar: SideBar[] = [
    ...
    // },
    {
      tittle: 'Accomodations',
      base: 'hotel',
      subTitle:'Hotel Booking',
      showAsTab: false,
      separateRoute: false,
      twoTitle:false,
      navLocation: 'accomodations',
    ...
    {
      tittle: 'Travel Assistance',
      base: 'car',
      subTitle:'Car Booking',
      showAsTab: false,
      separateRoute: false,
      twoTitle:false,
      navLocation: 'travel-assistance',
    ...
    {
      tittle: 'Special Event',
      base: 'tour',
      subTitle:'Tour Booking',
      showAsTab: false,
      separateRoute: false,
      twoTitle:false,
      navLocation: 'special-event',
