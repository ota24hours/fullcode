...
export const createPropertyUserVariant = async (req: Request, res: Response) => {
  let uploadedFileUrl: string = "";

  try {
    const { propertyId, name, rate, tax, max_person, person_allowed, extra_bed_available, rate_for_extra_bed, total_units_available ,min_rate ,extraData,child_count,waiting_rate,daily_rate,detailsData,
    ...
    const variant = variantRepo.create({
      ...
      waiting_rate:waiting_rate,daily_rate:daily_rate,
      capacity:capacity,
      staff:staff,
      lifeBoys:lifeBoys,
